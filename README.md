...
Validator for incoming born digital transfers.
...
```
git clone https://github.com/RockefellerArchiveCenter/born_digital_validation.git
cd born_digital_validation
docker build -t born_digital_validation .
docker run born_digital_validation
```
...
This validator expects to receive valid BagIt bags serialized as a single `.tar.gz` file.
